package com.onepiece.rm.trade.index.calc;

import com.onepiece.rm.trade.index.calc.job.PanIndexJob;
import com.onepiece.rm.trade.index.calc.model.Transaction;
import com.onepiece.rm.trade.index.calc.model.TransactionDeserializer;
import com.onepiece.rm.trade.index.calc.model.result.PanResult;
import com.onepiece.rm.trade.index.calc.model.result.PanResultSerializer;
...
public class IndexCalcApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String inputTopic = params.get("input-topic", "transactions");
        String outputTopic = params.get("output-topic", "indexes");
